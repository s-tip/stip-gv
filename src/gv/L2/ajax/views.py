...
def set_alchemy_nodes(aj,content):
    #stix version check
    if content['version'].startswith('2.') == True:
        is_stix_v2 = True
    else:
        is_stix_v2 = False
    ...
    if is_stix_v2 == True:
        if isinstance(content,dict) == True:
    ...
    if is_stix_v2 == True:
        ...
        for o_ in package['objects']:
            ...
            elif object_type.startswith('x-') == True:
