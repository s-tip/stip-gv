(function($){
    $.fn.funcResizeBox = function(userOptions){
        ...
        $(this).mousedown(function(e){
            ...
            var hambargar_icon = $('#drawer-hamburger');
            var hambargar_icon_offset = hambargar_icon.offset();
            ...
            $(document).mousemove(function(e){
                ...
                if(resize_right_flg && resize_width <= option.maxWidth
                    ...
                    hambargar_icon_offset.left += (e.pageX - hambargar_icon_offset.left);
                    hambargar_icon.offset(hambargar_icon_offset);
                }
